...
function draw() {
  ...
  //teclaPresionada();
  /*Matter.Body.applyForce(bob1.body, bob1.body.position,{x:-50,y:-45});  Si funciona pero no con flecha arriba
  if(keyDown(UP_ARROW)){
	Matter.Body.applyForce(bob1.body, bob1.body.position,{x:-50,y:-45});  No se no funciona
  }*/
  if(keyCode===UP_ARROW){
